...
type LinkServiceClient interface {
	...
	GetLink(ctx context.Context, in *ReadLinkRequest, opts ...grpc.CallOption) (*ReadLinkResponse, error)
...
func (c *linkServiceClient) GetLink(ctx context.Context, in *ReadLinkRequest, opts ...grpc.CallOption) (*ReadLinkResponse, error) {
	out := new(ReadLinkResponse)
	err := c.cc.Invoke(ctx, "/proto.LinkService/GetLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkServiceClient) DeleteLink(ctx context.Context, in *DeleteLinkRequest, opts ...grpc.CallOption) (*DeleteLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.LinkService/DeleteLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LinkServiceServer interface {
	...
	GetLink(context.Context, *ReadLinkRequest) (*ReadLinkResponse, error)
...
func (UnimplementedLinkServiceServer) GetLink(context.Context, *ReadLinkRequest) (*ReadLinkResponse, error) {
...
func _LinkService_GetLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.LinkService/GetLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LinkServiceServer).GetLink(ctx, req.(*ReadLinkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _LinkService_DeleteLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.LinkService/DeleteLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var LinkService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "shorturl_proto/shorturl.proto",
}
